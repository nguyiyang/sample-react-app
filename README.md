# Adapted from CVWO Assignment Sample React App

This React app has been adapted from the CVWO Assignment Sample React App.
It includes simple CRUD operations of categories and tasks.
It also includes operations to search and sort tasks.
